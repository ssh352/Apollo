...
if __name__ == "__main__":
    ...
    date_base = pydt.date(2018, 7, 1)
    date_now = pydt.date.today()
    date_delta = (date_now - date_base).days

    if date_delta > 365:
        print "COPYRIGHT (C) 2017 WIND INFORMATION CO., LTD. ALL RIGHTS RESERVED."
        print "IN NO CIRCUMSTANCE SHALL WIND BE RESPONSIBLE FOR ANY DAMAGES OR LOSSES CAUSED " \
              "BY USING WIND QUANT API FOR Python."
