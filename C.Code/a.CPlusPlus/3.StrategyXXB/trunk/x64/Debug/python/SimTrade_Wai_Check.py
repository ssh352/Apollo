...
# 根据展期收益率排名获取多空组合
def get_extension_list(date_now, ext_list):
    dict_rate = {}
...
# 输出交易品种记录
def get_trade_item(date_now,long_list, short_list):
...
if __name__ == "__main__":
    ...
    for date_now in ['2017-12-08','2017-12-11','2017-12-12','2017-12-13','2017-12-14','2017-12-15','2017-12-18']:


        list_valid = get_valid_list(date_now)

        print "list_valid:", list_valid

        long_item, short_item = get_extension_list(date_now, list_valid)

        print "long_item:", long_item
        print "short_item:", short_item

        get_trade_item(date_now, dict(long_item).keys(), dict(short_item).keys())
