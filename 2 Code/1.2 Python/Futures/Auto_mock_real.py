...
def get_valid_list():
    ...
    for item in list_item:
        ...
        if result.ErrorCode == 0 and None not in result.Data[0]:
...
def get_extension_list(ext_list, flag):
    ...
    result = w.tdaysoffset(0, date_base, "")
    ...
    for item in ext_list:
        ...
        if result.ErrorCode == 0:
            ...
            if result_main.ErrorCode == 0 and len(result_main.Data[0]) != 0:
                ...
                if not isinstance(main_contract_price.Data[0][0],(int,float)) or not isinstance(second_contract_price.Data[0][0],(int,float)):
                    continue
